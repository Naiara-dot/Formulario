...
function ValideInputs(){
	...
	function setErrorFor(input, message){
		...
		formControl.className = 'form-grupo-error';
		alertError.innerText = message;
	
		formControl.classList.add('icon-error');
		formControl.classList.remove('icon-success');
		}
		function setSuccessFor(input){
			const formControl = input.parentElement;
			formControl.className = 'form-grupo-success';
		
			formControl.classList.add('icon-success');
